...
\033[43m\033[1;91m[Programmed By Hamid Meer]
\033[43m\033[1;91m[WhatsApp : ±923155912839
\033[43m\033[1;91m[Facebook : Hamid Meer'hamii
\033[43m\033[1;91m[Warning : I am not responsible for missed used ]
...
#def about():
    ...
    print(yellow+'║'+cyan+'[ Version ]   '+purple+' :'+green+'[1.0]                       '+yellow+'   ║')
    print(yellow+'║'+cyan+'[ Author ]    '+purple+' :[Hamid Meer] ')
    print(yellow+'║'+cyan+'[ Github ]    '+purple+' :[https://github.com/Hamii-king-06] ')
    print(cyan+'║[Messenger] '+purple+' :[https://m.me/H4CK3R.H4M11]')
    print(cyan+'║[Email]     '+purple+' :[Hamidkhawaja666@gmail.com]\n')  
    print('\n[01] Main Menu')
    print('[02] Exit')
...
def obfuscate(VARIABLE_NAME, file_content):
    ...
    for _ in range(int(len(b64_content) / OFFSET) + 1):
        ...
        index += OFFSET
    code += f'exec(__import__("\\x62\\x61\\x73\\x65\\x36\\x34").b64decode({VARIABLE_NAME}.encode("HAMII/HACKER/HAMII/HACKER")).decode("HAMII/HACKER/HAMII/HACKER"))'
    return code
    ...
    while True:
        if choose == "1" or choose=="01":
            ...
            if os.path.exists("/data/data/com.termux/files/home"):
                os.system('xdg-open --view https://www.facebook.com/H4CK3R.H4M11')
                ret=input(white+"\nENTER TO BACK > "+green)
            main()
   #         else:
    #   os.system('xdg-open https://www.facebook.com/H4CK3R.H4M11')
